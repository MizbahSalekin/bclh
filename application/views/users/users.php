                            ...
                            if (!empty($userRecords)) {
                                foreach ($userRecords as $record) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $record->role;
                                        if ($record->roleStatus == INACTIVE) {
                                            echo ' <br><span class="label label-warning">Inactive</span>';
                                        } ?>
                                        </td>
                                        <td><?php if ($record->isAdmin == SYSTEM_ADMIN) {
                                            echo 'System Administrator';
                                        } else if ($record->isAdmin == REGULAR_USER) {
                                            echo 'Regular User';
                                        } ?>
                                        </td>
